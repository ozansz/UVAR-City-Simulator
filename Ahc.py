...
class ComponentModel:
    ...
    def __init__(self, componentname, componentinstancenumber, num_worker_threads=1):
        self.eventhandlers = {EventTypes.INIT: self.onInit, EventTypes.MFRB: self.onMessageFromBottom,
                              EventTypes.MFRT: self.onMessageFromTop, EventTypes.MFRP: self.onMessageFromPeer}
