...
class ChandyLamportSnapshot(ComponentModel):
    ...
    def onInit(self, eventobj: Event):
        ...
        self.recorded = False
        self.marker = {}
        self.myneighbors = Topology().getNeighbors(self.componentinstancenumber)
        ...
        if self.componentinstancenumber == 0:
            time.sleep(2)
            self.sendself(Event(self, SnapshotsEventTypes.TAKESNAPSHOT, None))

    def senddownbroadcast(self, eventobj: Event, whosends):
